...
class detectCar(object):
    ...
    def __init__(self):
        ...
        self.model.eval()
        self.model.load_state_dict(torch.load("D:/0/detection/DD/MDC/detectCar/carClassify.pth", map_location='cpu'))
    ...
    def readclasses(self):
        with open("D:/0/detection/DD/MDC/detectCar/classes.json","r") as f:
            classes=json.load(f)
        return classes
